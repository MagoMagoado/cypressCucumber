const sauceElementos = {
  ...
  BOTAO: {
    ...
    'Add Sauce Labs Backpack': { seletor: '[data-test^="add-to-cart"]', produtoNome: 'Sauce Labs Backpack' },
    'Add Sauce Labs Bike Light': { seletor: '[data-test^="add-to-cart"]', produtoNome: 'Sauce Labs Bike Light' },
